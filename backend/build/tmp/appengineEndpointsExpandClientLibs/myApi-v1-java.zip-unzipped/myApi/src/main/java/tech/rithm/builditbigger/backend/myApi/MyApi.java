 ...
 * on 2016-11-20 at 18:12:59 UTC 
 * Modify at your own risk.
 */

package tech.rithm.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-150117.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<tech.rithm.builditbigger.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, tech.rithm.builditbigger.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<tech.rithm.builditbigger.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, tech.rithm.builditbigger.backend.myApi.model.MyBean.class);
